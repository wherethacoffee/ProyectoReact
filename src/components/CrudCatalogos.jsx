...
import {registerAlumno, listAlumno, deleteAlumno, updateAlumno} from '../services/alumno.services'; 
import {registerRepresentante, listRepresentante, deleteRepresentante, updateRepresentante} from '../services/representante.services'  
import { registerAsunto , listAsunto, deleteAsunto, updateAsunto} from '../services/asunto.services'
import {registerNivel, listNivel, deleteNivel, updateNivel} from '../services/nivel.services'
import {registerEstado, listEstado, updateEstado, deleteEstado}from '../services/estado.services'
import {registerMunicipio,listMunicipio,updateMunicipio, deleteMunicipio} from '../services/municipio.services'
import {registerAdmin, listAdmins, updateAdmin, deleteAdmin} from '../services/admin.services'
    ...
    <div className="crud-container">
      ...
      {selectedForm && (
        ...
        <div className="form-container-crud">
          ...
          <h2>Listado de Alumnos</h2>
      <CustomTable columns={columnsRepresentantes} data={representantes} />
      ...
      {selectedForm === 'municipio' && (
        <div className="form-container-crud">
          ...
          <select id="estado" name="estado"value={formData.idEstado || ''}
          onChange={(e) => setFormData({ ...formData, idEstado: e.target.value })}>
