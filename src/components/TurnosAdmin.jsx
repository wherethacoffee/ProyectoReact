                        ...
                        <div>
                            ...
                            <label>
                                ...
                                <select
                                    ...
                                    onChange={(e) => setEditedData({ ...editedData, idRep: e.target.value })}
                                >
                                    <option value={null}>Selecciona un representante</option>
                                    {representantes.map((representante) => (
                                        <option key={representante.idRep} value={representante.idRep}>
                            ...
                            <label>
                                ...
                                <input
                                    ...
                                    onChange={(e) => setEditedData({ ...editedData, curp: e.target.value })}
                                />
                            </label>
                            <br />
                            <label>
                                ...
                                <select
                                    ...
                                    onChange={(e) => setEditedData({ ...editedData, idMunicipio: e.target.value })}
                                >
                            ...
                            <label>
                                ...
                                <select
                                    ...
                                    onChange={(e) => setEditedData({ ...editedData, idNivel: e.target.value })}
                                >
                            ...
                            <label>
                                ...
                                <select
                                    ...
                                    onChange={(e) => setEditedData({ ...editedData, idAsunto: e.target.value })}
                                >
